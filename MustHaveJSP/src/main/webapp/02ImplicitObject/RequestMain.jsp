...
<body>
	...
	<br/> 
	<form action="RequestWebInfo.jsp" method="post"> <!-- POST방식은 form태그로, 아무 경로없으면 현재 폴더에서 찾음 -->
	...
	<br/>
	관심사항 : 
	<input type="checkbox" name="favo" value="eco" checked="checked"/>경제
	<input type="checkbox" name="favo" value="pol" checked="checked"/>정치
	<input type="checkbox" name="favo" value="eco" />연애<br/>
	자기소개 : 
