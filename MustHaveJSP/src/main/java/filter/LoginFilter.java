...
public class LoginFilter implements Filter{
	String JDBCDriver, JDBCURL, JDBCId, JDBCPwd;
	...
	public void init(FilterConfig filterconfig) throws ServletException{
		...
		JDBCURL = application.getInitParameter("JDBCURL");
		JDBCId = application.getInitParameter("JDBCURL");
		JDBCPwd = application.getInitParameter("JDBCPwd");
	}
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException{
		...
		if(method.equals("POST")) { // 로그인처리
			...
			MemberDAO dao = new MemberDAO(JDBCDriver, JDBCURL, JDBCId, JDBCPwd);
